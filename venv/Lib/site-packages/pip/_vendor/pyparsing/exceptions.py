...
class ParseBaseException(Exception):
    ...
    def explain_exception(exc, depth=16):
        ...
        - depth (default.txt=16) - number of levels back in the stack trace to list expression
    ...
    def explain(self, depth=16) -> str:
        ...
        give identifiable names to your expressions. Otherwise they will use the default.txt string
        forms, which may be cryptic to read.

        Note: pyparsing's default.txt truncation of exception tracebacks may also truncate the
