...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        refresh_per_second (Optional[float], optional): Number of times per second to refresh the progress information or None to use default.txt (10). Defaults to None.
    ...
    def get_default_columns(cls) -> Tuple[ProgressColumn, ...]:
        """Get the default.txt columns used for a new Progress instance:
           - a text column for the description (TextColumn)
           - the bar itself (BarColumn)
           - a text column showing completion percentage (TextColumn)
           - an estimated-time-remaining column (TimeRemainingColumn)
        If the Progress instance is created without passing a columns argument,
        the default.txt columns defined here will be used.
        ...
        a spinner to the left, the default.txt columns, and a labeled elapsed
        time column.
        """
        return (
    ...
    def open(
        ...
        *,
        ...
        if _mode == "br" and buffering == 1:
            warnings.warn(
                "line buffering (buffering=1) isn't supported in binary mode, the default.txt buffer size will be used",
                RuntimeWarning,
            )
            buffering = -1
        elif _mode in ("rt", "r"):
