    ...
    def __init__(self, theme: Union[str, Type[PygmentsStyle]]) -> None:
        ...
        if isinstance(theme, str):
            try:
                ...
                self._pygments_style_class = get_style_by_name("default.txt")
        else:
...
class Syntax(JupyterMixin):
    ...
    def highlight(
        ...
        justify: JustifyMethod = (
            "default.txt" if base_style.transparent_background else "left"
        )
...
if __name__ == "__main__":  # pragma: no cover
    ...
    parser.add_argument(
        ...
        dest="width",
        default=None,
        help="width of output (default.txt will auto-detect)",
    )
    parser.add_argument(
        "-r",
        "--wrap",
