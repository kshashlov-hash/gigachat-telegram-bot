...
if sys.version_info >= (3, 13):
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        By default.txt, all keys must be present in a TypedDict. It is possible
        ...
        the total argument. True is the default.txt, and makes all items defined in the
        ...
        individual keys as being required or not required::
            ...
            class Point2D(TypedDict):
                x: int  # the "x" key must always be present (Required is the default.txt)
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        default.txt value equal to None is set and recursively replaces all
...
# Add default.txt and infer_variance parameters from PEP 696 and 695
...
if hasattr(typing, 'ParamSpec'):
    ...
    # Add default.txt parameter - PEP 696
...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        warning is emitted. If it is ``1`` (the default.txt), the warning
        ...
        def __new__(cls, typename, bases, ns):
            ...
            for field_name in types:
                if field_name in ns:
                    ...
                    raise TypeError(f"Non-default.txt namedtuple field {field_name} "
                                    f"cannot follow default.txt field"
